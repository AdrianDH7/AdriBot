...
if (stiker) conn.sendFile(m.chat, stiker, 'sticker.webp', '',m, true, { contextInfo: { 'forwardingScore': 200, 'isForwarded': false, externalAdReply:{ showAdAttribution: false, title: packname, body: `AdriBot-MD 🍭`, mediaType: 2, sourceUrl: canal, thumbnail: icono}}}, { quoted: m })

else return conn.reply(m.chat, '🍭 *_La conversión ha fallado, intenta enviar primero imagen/video/gif y luego responde con el comando._*\n\n> 🍭 Sigue El Canal 🍭', m, rcanal)
